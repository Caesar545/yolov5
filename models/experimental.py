...
from detectors.intelligentAlgorithm.yolov5.utils.downloads import attempt_download
...
def attempt_load(weights, device=None, inplace=True, fuse=True):
    ...
    """
    from detectors.intelligentAlgorithm.yolov5.models.yolo import Detect, Model
